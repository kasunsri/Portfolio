  ...
  return (
    <div className="max-w-[1400px] mx-auto px-4 py-16 md:py-24 flex flex-col gap-16" id="about">
      ...
      <motion.div
        ...
        className="group relative flex flex-col lg:flex-row gap-8 bg-gradient-to-br from-gray-900/90 to-gray-800/70 backdrop-blur-2xl rounded-3xl shadow-2xl border border-gray-700/50 overflow-hidden transform transition-all duration-500 hover:border-cyan-400/30"
      >
        ...
        <motion.div
          ...
          className="flex-1 flex flex-col justify-center p-10 space-y-8"
        >
      ...
      <motion.div
        ...
        whileInView="visible"
        viewport={{ once: true, margin: "-100px" }}
        className="group relative flex flex-col lg:flex-row-reverse gap-8 bg-gradient-to-bl from-gray-900/90 to-gray-800/70 backdrop-blur-2xl rounded-3xl shadow-2xl border border-gray-700/50 overflow-hidden transform transition-all duration-500 hover:border-blue-400/30"
      >
        <motion.div
          initial={{ scale: 0.98 }}
          whileInView={{ scale: 1 }}
      ...
      <motion.div
        ...
        whileInView="visible"
        viewport={{ once: true, margin: "-100px" }}
        className="group relative flex flex-col lg:flex-row gap-8 bg-gradient-to-br from-gray-900/90 to-gray-800/70 backdrop-blur-2xl rounded-3xl shadow-2xl border border-gray-700/50 overflow-hidden transform transition-all duration-500 hover:border-purple-400/30"
      >
        <motion.div
          initial={{ scale: 0.98 }}
          whileInView={{ scale: 1 }}
